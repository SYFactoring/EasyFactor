    ...
    public partial class AssignBatchMgr : UserControl
    {
            ...
            : this(OpBatchType.QUERY)
        {
            if(username == null)
            {
                ...
                IQueryable<InvoiceAssignBatch> queryResult = from batch in Context.InvoiceAssignBatches
                                              where
        ...
        private void Check(object sender, EventArgs e)
        {
            ...
            InvoiceAssignBatch batch = (InvoiceAssignBatch)this._bs.List[this.dgvBatches.CurrentCell.RowIndex];
                                              ...
                                              string transactionType)
        {
            ...
            sheet.Protect(Type.Missing, true, true, true, true, true, Type.Missing, Type.Missing, Type.Missing,
