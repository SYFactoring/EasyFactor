...
namespace CMBC.EasyFactor.Utils
{
    ...
    class ExportUtil
    {
        ...
        public void StartExport(object[] objArray)
        {
        ...
        private void backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            switch (exportType)
            {
                case ExportType.EXPORT_ASSIGN_FINANCE_PAYMENT:
                    ExportAssignFinancePayment((object[])e.Argument, worker);
                    break;
                default:
                    break;
            }
        ...
        private void ExportAssignFinancePayment(object[] objArray, BackgroundWorker worker)
        {
            ...
            int size = objArray.GetUpperBound(0);
